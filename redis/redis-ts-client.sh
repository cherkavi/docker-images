...
sudo docker run --interactive --tty --rm --link $LOCAL_CONTAINER_NAME:$DOCKER_IMAGE_NAME $DOCKER_IMAGE_NAME redis-cli -h $LOCAL_CONTAINER_NAME -p $LOCAL_CONTAINER_PORT
